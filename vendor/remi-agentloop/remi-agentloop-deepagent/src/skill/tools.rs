//! Skill tools: save, get, list, delete.
...
/// Save (or overwrite) a named skill as a markdown document.
///
/// Skills are reusable instructions the model can recall and apply to future
/// tasks — store things like "how to set up a Rust project" or "coding style
/// guidelines".
...
/// Permanently delete a saved skill.
